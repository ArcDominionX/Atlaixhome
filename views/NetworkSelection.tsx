...
export const NetworkSelection: React.FC<NetworkSelectionProps> = ({ onSelect, onBack }) => {
    return (
        <div className="min-h-screen flex flex-col items-center justify-center p-6 bg-main animate-fade-in text-center">
            <div className="mb-8">
                <img src="https://i.ibb.co/LtbW0q2/alphatrackerlogo.png" alt="Logo" className="w-20 h-20 mx-auto object-contain mb-4" onError={(e) => e.currentTarget.src='https://via.placeholder.com/80'} />
